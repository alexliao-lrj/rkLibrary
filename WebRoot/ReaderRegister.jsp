...
<form class="form-horizontal" action="/dbLibrary/servlet/addreader" method="post">
  <div class="form-group">
    <label for="InputReader_ID">用户ID</label>
    <input type="text" class="form-control" id="InputReader_ID" name="rid" placeholder="用户ID">
  </div>
  <div class="form-group">
    <label for="InputReader_name">用户姓名</label>
    <input type="text" class="form-control" id="InputReader_name" name="name" placeholder="用户姓名">
  </div>
  <div class="form-group">
    <label for="InputReader_pwd">用户密码</label>
    <input type="text" class="form-control" id="InputReader_pwd" name="pwd" placeholder="用户密码">
  </div>
  <div class="form-group">
    <label for="InputReader_number">可借上限</label>
    <input type="text" class="form-control" id="InputReader_number" name="number" placeholder="最大可借数量">
  </div>
...
<<script>
	var fail = '<%=request.getParameter("addreaderfail")%>';
	if(fail == 'yes'){
		alert("注册失败，用户已存在！");
	}
</script>
