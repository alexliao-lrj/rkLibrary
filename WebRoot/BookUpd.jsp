...
<form class="form-horizontal" action="/dbLibrary/servlet/updatebook" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="InputBook_isbn" name="isbn" placeholder="ISBN">
  </div>
  <div class="form-group">
    <label for="InputBook_publisher">出版社</label>
    <input type="text" class="form-control" id="InputBook_publiser" name="publisher" placeholder="出版社">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="InputBook_price" name="price" placeholder="定价">
  </div>
  <div class="form-group">
...
<script>
	var failed = '<%=request.getParameter("updatebookfail")%>'
	if(failed == 'yes'){
		alert("没有这本书的信息！");
	}
</script>
