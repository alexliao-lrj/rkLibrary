...
<form class="form-horizontal" action="/dbLibrary/servlet/returnbook" method="post">
  <div class="form-group">
    <label for="InputBook_ID">图书ID</label>
    <input type="text" class="form-control" id="InputBook_ID" name="bookid" placeholder="图书ID">
  </div>
  <div class="form-group">
    <label for="InputBook_name">借阅者ID</label>
    <input type="text" class="form-control" id="InputBook_name" name="readerid" placeholder="借阅者ID">
  </div>

  <button type="submit" class="btn btn-default">还书申请</button>
</form>
</div>
...
<script>
	var returnfailed = '<%=request.getParameter("returnfail")%>'
	if(returnfailed == 'yes'){
		alert("还书失败！");
	}
</script>
