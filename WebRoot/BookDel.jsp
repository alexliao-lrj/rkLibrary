...
<form class="form-horizontal" action="/dbLibrary/servlet/deletebook" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="InputBook_name" name="bname" placeholder="图书名称">
  </div>

  <button type="submit" class="btn btn-default">确认下架</button>
</form>
</div>
...
<script>
	var failed = '<%=request.getParameter("deletebookfail")%>'
	if(failed == 'yes'){
		alert("删除图书失败！请检查输入信息！");
	}
</script>
