...
<form class="form-horizontal" action="/dbLibrary/servlet/searchbookAction" method="post">
...
<script>
	var borrowfailed = '<%=request.getParameter("borrowfail")%>'
	if(borrowfailed == 'yes'){
		alert("借书失败！");
	}
	var searchfailed = '<%=request.getParameter("searchfail")%>'
	if(searchfailed == 'yes'){
		alert("查询失败！请重试！");
	}
</script>