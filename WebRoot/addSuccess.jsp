            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="javascript:alert('不会自己修改信息的蛤丝姿势水平还不行啊(_)-(_) ')">信息更新</a></li>
...
<table class="table">
 ...
 <tbody>
 <%
 	Book bk = (Book)request.getSession().getAttribute("addbook"); 
 	
 		out.print("<tr>");
 		out.print("<th>"+bk.getbid()+"</th>");
 		out.print("<th>"+bk.getname()+"</th>");
 		out.print("<th>"+bk.getauthor()+"</th>");
 		out.print("<th>"+bk.getedition()+"</th>");
 		out.print("<th>"+bk.getpublisher()+"</th>");
 		out.print("<th>"+bk.getpage()+"</th>");
 		out.print("<th>"+bk.getprice()+"</th>");
 		out.print("<th>"+bk.getisbn()+"</th>");
 		out.print("<th>"+bk.gettranslator()+"</th>");
 		out.print("<th>"+bk.getoperator()+"</th>");
 		out.print("<th>"+bk.getinTime()+"</th>");
 		out.print("</tr>");
